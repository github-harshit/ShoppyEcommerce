...
const Categories = () => {
  return (
    <div className='w-full  md:h-[27rem] border border-black' >
        <div className='w-full h-[50rem] md:h-[27rem] flex flex-col md:flex-row gap-2 px-2' >
            <div className='w-full md:w-1/3 h-full flex justify-center items-center opacity-80' style={{background: `url(${menFashion})`,backgroundSize: "cover",}} >
            ...
            <div className='w-full h-full md:w-1/3  flex justify-center items-center opacity-80' style={{backgroundImage:`url(${womenFashion})`, backgroundSize: 'cover'}} >
            <div className='opacity-100  flex flex-col items-center gap-3 '>
            ...
            <div className='w-full h-full md:w-1/3  flex justify-center items-center opacity-80' style={{backgroundImage: `url(${kidsFashion})`, backgroundSize: "cover"}}>
            <div className='opacity-100  flex flex-col items-center gap-3 '>
